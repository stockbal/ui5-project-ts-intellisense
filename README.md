...
This sample SAPUI5 project demonstrates how to get intellisense support in VS Code via the help of `@sapui5/types` package ES6 module syntax supported by the UI5 task/middleware `ui5-tooling-transpile`.
